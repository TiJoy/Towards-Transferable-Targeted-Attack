...
def graph(x, y, i, x_max, x_min, grad, y_target, y_logits):
    ...
    logits = (logits_v4 + logits_res_v2 + logits_v3 + logits_resnet + logits_resnet_50 + logits_resnet_101 + logits_ens4_adv_v3 + logits_ensadv_res_v2) / 8

    auxlogits = (end_points_v4['AuxLogits'] + end_points_res_v2['AuxLogits'] + end_points_v3['AuxLogits'] +
                 end_points_ens4_adv_v3['AuxLogits'] + end_points_ensadv_res_v2['AuxLogits']) / 5
