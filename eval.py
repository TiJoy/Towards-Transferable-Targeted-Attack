...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        acc_v3, acc_v4, acc_res_v2, acc_resnet, acc_resnet_50, acc_resnet_101, pred1, pred2, pred3, pred4 = Evaluator(x_input, y_true)
        ...
        with tf.Session() as sess:
            ...
            for filenames, images, y, y_tar in load_images(FLAGS.output_dir, batch_shape,true_label_list, target_label_list):
                ...
                if FLAGS.eval_y == 'y_true':
                    eval_y = y
                acc_v3_, acc_v4_, acc_res_v2_, acc_resnet_,acc_resnet_50_,acc_resnet_101_, pred1_, pred2_, pred3_, pred4_ = \
                    sess.run([acc_v3, acc_v4, acc_res_v2, acc_resnet, acc_resnet_50, acc_resnet_101, pred1, pred2, pred3, pred4],
        ...
        print(acc_num_v3_, acc_num_v4_, acc_num_res_v2_, acc_num_resnet_, acc_num_resnet_50, acc_num_resnet_101, num)
